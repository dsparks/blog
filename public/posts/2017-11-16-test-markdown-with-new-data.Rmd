...
The plot below simply draws a point at each (from, to) verse pair. There isn't much to be gleaned here, other than the fact that verses are more likely to refer to more proximate verses than cite across books and sections. The mean distance between citing verse and cited verse (i.e. the number of verses between them) is `r with(numericAdjacency, mean(abs(toID - fromID)))`; the median is `r with(numericAdjacency, median(abs(toID - fromID)))`.
